...
declare namespace monaco.extra {
    ...
    export abstract class ResolvedKeybinding {
         ...
         */
        abstract getSingleModifierDispatchParts(): (string | null)[];
    }
    ...
    export const IProgressService: any;
    ...
    export const IEditorProgressService: any;
    ...
    export const IKeybindingService: any;
    ...
    export class StandaloneKeybindingService extends AbstractKeybindingService {
        ...
        updateResolver(event: IKeybindingEvent): void;
     ...
     */
        ...
        export const ISnippetsService: any;
        ...
        export interface ISnippetsService {
            ...
            getSnippets(languageId: languages.LanguageId, opt?: ISnippetGetOptions): Promise<Snippet[]>;
            getSnippetsSync(languageId: languages.LanguageId, opt?: ISnippetGetOptions): Snippet[];
        }
        ...
        export function handleLanguageConfiguration(languageIdentifier: languages.LanguageIdentifier, configuration: ILanguageConfiguration): void;
        ...
        export const IExtensionResourceLoaderService: any;
        ...
        export class TMGrammarFactory extends Disposable {
            ...
            has(languageId: languages.LanguageId): boolean;
            setTheme(theme: import('vscode-textmate').IRawTheme, colorMap: string[]): void;
            getColorMap(): string[];
            createGrammar(languageId: languages.LanguageId): Promise<ICreateGrammarResult>;
        }
    ...
    declare namespace monaco.editor {
        ...
        export class DiffEditorWidget extends Disposable implements IDiffEditor {
            ...
            updateOptions(newOptions: Readonly<IDiffEditorOptions>): void;
        ...
        export module StaticServices {
            ...
            const instantiationService: LazyStaticService<any>;
            const configurationService: LazyStaticService<any>;
            const resourceConfigurationService: LazyStaticService<any>;
            const resourcePropertiesService: LazyStaticService<any>;
            const contextService: LazyStaticService<any>;
            const labelService: LazyStaticService<any>;
            const telemetryService: LazyStaticService<any>;
            const dialogService: LazyStaticService<any>;
            const notificationService: LazyStaticService<any>;
            const markerService: LazyStaticService<any>;
            const modeService: LazyStaticService<any>;
            const standaloneThemeService: LazyStaticService<any>;
            const logService: LazyStaticService<any>;
            const undoRedoService: LazyStaticService<any>;
            const modelService: LazyStaticService<any>;
            const markerDecorationsService: LazyStaticService<any>;
            const contextKeyService: LazyStaticService<any>;
            const codeEditorService: LazyStaticService<any>;
            const editorProgressService: LazyStaticService<any>;
            const storageService: LazyStaticService<any>;
            const editorWorkerService: LazyStaticService<any>;
        }
        ...
        export const IThemeService: any;
        ...
        */
        ...
        export abstract class AbstractCodeEditorService extends Disposable implements ICodeEditorService {
            readonly _serviceBrand: undefined;
            readonly onCodeEditorAdd: IEvent<ICodeEditor>;
            readonly onCodeEditorRemove: IEvent<ICodeEditor>;
            readonly onDiffEditorAdd: IEvent<IDiffEditor>;
            readonly onDiffEditorRemove: IEvent<IDiffEditor>;
            readonly onDidChangeTransientModelProperty: IEvent<ITextModel>;
        ...
        export abstract class CodeEditorServiceImpl extends AbstractCodeEditorService {
            constructor(styleSheet: GlobalStyleSheet | null, themeService: IThemeService);
        ...
        export class StandaloneCodeEditorServiceImpl extends CodeEditorServiceImpl {
            constructor(styleSheet: GlobalStyleSheet | null, contextKeyService: extra.IContextKeyService, themeService: IThemeService);
            ...
            doOpenEditor(editor: ICodeEditor, input: ITextResourceEditorInput): ICodeEditor | null;
        }
        ...
        export class FoldingController extends Disposable implements IEditorContribution {
            ...
            constructor(editor: ICodeEditor, contextKeyService: extra.IContextKeyService);
            /**
             * Store view state.
             */
        ...
        export interface IModelService {
            readonly _serviceBrand: undefined;
            setMode(model: ITextModel, languageSelection: languages.ILanguageSelection): void;
            destroyModel(resource: Uri): void;
            getModels(): ITextModel[];
            getCreationOptions(language: string, resource: Uri, isForSimpleWidget: boolean): ITextModelCreationOptions;
            getModel(resource: Uri): ITextModel | null;
            onModelAdded: IEvent<ITextModel>;
            onModelRemoved: IEvent<ITextModel>;
    ...
    declare namespace monaco.languages {
        ...
        export interface ILanguageSelection {
            ...
            readonly onDidChange: IEvent<LanguageIdentifier>;
        }
        /**
        ...
        export class LanguageConfigurationRegistryImpl {
             ...
             */
            register(languageIdentifier: LanguageIdentifier, configuration: LanguageConfiguration, priority?: number): IDisposable;
